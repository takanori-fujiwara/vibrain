...
private slots:
  ...
  void
  setScannedDatasetPositionsAndUpdate(QVector<QPair<int, int>> targetLinks);
  void setScannedDatasetPositionsWithSettings(QString distCalcMethod,
                                              QString matrixKey);
  void setScannedDatasetPositionsWithSelectedData();
  void setScannedDatasetPositionsWithSelectedMatrixElements();
  void setScannedDatasetFilteredOut(
  ...
  void updateDataDirectories(QString baseDataDir, QString brainMeshDir,

...
private:
    ...
    void drawLinks(GLenum mode, bool edgeColoringByGroup = false, bool bundlingEdge = false);
    void paintLegend();
    void paintPopup();
    void drawCube(float centerX, float centerY, float centerZ, float size, QColor color, bool withFill = true);

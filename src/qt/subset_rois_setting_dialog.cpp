...
SubsetRoisSettingDialog::SubsetRoisSettingDialog(Rois *rois, QWidget *parent)
{
    ...
    connect(cancelBtn, &QPushButton::clicked, this, &SubsetRoisSettingDialog::handleCancelBtn);
    connect(okBtn, &QPushButton::clicked, this, &SubsetRoisSettingDialog::handleOkBtn);
...
void SubsetRoisSettingDialog::handleCancelBtn()
{
    close();
}

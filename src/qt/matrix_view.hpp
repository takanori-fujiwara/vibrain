...
private:
    ...
    void drawDetailedMatrix(float x, float y, float size, QVector<QColor> colormap, QColor strokeColor = QColor(0,0,0,0), float strokeWidth = 0.0);
    void drawGroupLines(float x, float y, float size, QVector<QColor> groupColors);
    ...
    void drawHoveredRoiLines(float matrixStartX, float matrixStartY, float matrixSize);
    void paintPopup();

...
{
public:
    BrainMesh(const QString &brainMeshFilePath, const QString &spatialCorrectonFilePath);
    void resetBrainMesh(const QString &brainMeshFilePath, const QString &spatialCorrectonFilePath);
